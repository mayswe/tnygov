            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="pricing-table table-left">
                    ...
                    <div class="pricing-details">
                        ...
                        ?>
                        <div class="row">
                            <p><a class="group{{$package->id}}"  href="{{ asset('uploads/photo/' . $images[1]) }}" title="{{ $package->name }}"><img src="{{ asset('uploads/photo/' . $images[1]) }}"></a></p>
                            <?php
                        foreach($images as $image){
                            
                            ?>
                            
      <p><a class="group{{$package->id}}"  href="{{ asset('uploads/photo/' . $image) }}" title="{{ $package->name }}"></a></p>
			...
			$(document).ready(function(){
				...
				$(".group{{$package->id}}").colorbox({
                    rel:'group{{$package->id}}', 
                    slideshow:true,
                    scalePhotos : true,
                    width: '750px',
                    height:'499px'
