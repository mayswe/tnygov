                ...
                <div class="col-xl-9 col-lg-11 col-md-8">
                    <div class="card-login card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                <div class="col-lg-6"><h1 style="margin:35px auto; text-align:center;">Admin Login</h1>
                                
                                <div class="logotext flex text-center">
                                    <img src="https://www.tanintharyi.gov.mm/uploads/sitelogo.jpg" style="margin-bottom:25px;">
                                    <h3 style="line-height:45px;">{{__('messages.site_name')}}</h3>
