    ...
    <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12">
        <div class="card">
            <div class="card-header bg-dark text-white">
                Edit This Department : {{ $news->name }}
            </div>
            <div class="card-body">
                <a class="badge badge-pill badge-primary add-new-slider" href="{{ route('departmentpage') }}">
                    <i class="fas  fa-arrow-left"></i>
                    Back To Department List
                </a>
                <form action="{{ route('update.department',['id'=>$news->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
