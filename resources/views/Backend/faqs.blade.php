                ...
                <div class="table-responsive col-lg-10 offset-lg-1 col-md-12 col-sm-12 tab-pane fade show active" id="pills-questions" role="tabpanel" aria-labelledby="pills-questions-tab">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach($faqs as $faq)
                            <tr>
                                <th class="text-left p-4">{{ $faq->question }}</th>
                                <td class="text-center">
                                    <a class="btn btn-primary" href="{{ route('edit.faq', ['id'=>$faq->id]) }}">Edit</a>
                                    <a class="btn btn-danger" href="{{ route('delete.faq', ['id'=>$faq->id]) }}" title="">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
