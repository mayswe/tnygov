            ...
            <div class="card-body">
                ...
                <form action="{{ route('update.annualreport',['id'=>$annualreports->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="5" name="short_description" class="form-control">{{ $annualreports->short_description }}</textarea>
                    </div>
                    <div class="form-group">
                        <label class="home-page-label">Long Description</label>
                        <textarea rows="5" name="long_description" id="addpage" class="form-control">{{ $annualreports->long_description }}</textarea>
                    </div>
                    <div class="form-group">
