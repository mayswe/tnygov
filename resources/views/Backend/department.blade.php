        ...
        <div class="card website-settings-card shadow mb-5">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" >
                <li class="nav-item">
                    ...
                    id="pills-news-tab" data-toggle="pill" href="#pills-judges" role="tab" aria-controls="pills-news"><i class="fa fa-pencil"></i> Edit Department</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-news-tab" data-toggle="pill" href="#pills-addnews" role="tab" aria-controls="pills-addnews"><i class="fa fa-plus"></i> Add Department Detail</a>
                </li>
            </ul>
            <!-- End Nav -->
            <!-- Start Body -->
            <div class="row tab-content mt-2" id="pills-tabContent">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 186px;">
                                    <a class="btn btn-primary btn-sm" href="{{ route('edit.department', ['id'=>$new->id]) }}">Edit</a>
                                    <a class="btn btn-danger btn-sm" href="{{ route('delete.department', ['id'=>$new->id]) }}" >Delete</a>
                                    <a target="_blank" class="btn btn-info btn-sm" href="{{ route('singledd',['id'=>$new->id]) }}">View</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 tab-pane fade" id="pills-addnews" role="tabpanel" aria-labelledby="pills-addnews-tab">
                    <form class="form-horizontal" action="{{ route('add.department') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" placeholder="Enter Title.." class="form-control">
                        </div>
                        <div class="form-group">
