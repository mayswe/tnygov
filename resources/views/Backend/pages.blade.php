                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('edit.page', ['id'=>$page->id]) }}" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="{{ route('delete.page', ['id'=>$page->id]) }}" class="btn btn-danger btn-sm">Delete</a>
                                    <a target="_blank" class="btn btn-info btn-sm" href="{{ route('page', ['id'=>$page->id, 'title'=> str_replace(" ", "-", $page->title)]) }}">View</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
