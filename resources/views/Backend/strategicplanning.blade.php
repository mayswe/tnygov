        ...
        <div class="card website-settings-card shadow mb-5">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" >
                <li class="nav-item">
                    ...
                    id="pills-annualreports-tab" data-toggle="pill" href="#pills-annualreports" role="tab" aria-controls="pills-annualreports"><i class="fa fa-pencil"></i> Edit Your Strategic Planning</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-addannualreport-tab" data-toggle="pill" href="#pills-addannualreport" role="tab" aria-controls="pills-addannualreport"><i class="fa fa-plus"></i> Add New Strategic Planning</a>
                </li>
            </ul>
            <!-- End Nav -->
            <!-- Start Body -->
            <div class="row tab-content mt-2" id="pills-tabContent">
                ...
                <div class="table-responsive col-lg-10 offset-1 col-md-12 col-sm-12 tab-pane fade show active"
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center">Strategic Planning</th>
                                <th class="text-center">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($strategic_planning as $annualreport)
                            <tr>
                ...
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 tab-pane fade" id="pills-addannualreport" role="tabpanel" aria-labelledby="pills-addannualreport-tab">
                    <form action="{{ route('add.annualreport') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="home-page-label">Strategic Planning Name</label>
                            <input type="text" name="name"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="home-page-label">Strategic Planning Name (EN)</label>
