    ...
    <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12">
        <div class="card website-settings-card shadow mb-5">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" >
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-addcauselist-tab" data-toggle="pill" href="#pills-addcauselist" role="tab" aria-controls="pills-addcauselist"><i class="fa fa-plus"></i> Add New Cause List</a>
                </li>
            </ul>
            <!-- End Nav -->
            <!-- Start Body -->
            <div class="row tab-content mt-2" id="pills-tabContent">
                ...
                <div class="table-responsive col-lg-10 offset-1 col-md-12 col-sm-12 tab-pane fade show active"
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center">Cause Lists</th>
                                <th class="text-center">Cause Lists EN</th>
                        ...
                        <tbody>
                            ...
                            <?php
                            if($causelist->category_id==2){
                                $cname = 'ရာဇဝတ်မှု';
                            }else if($causelist->category_id==3){
                                $cname = 'တရားမမှု';
                            }else if($causelist->category_id==4){
                                $cname = 'စာချွန်တော်မှု';
                            }
                            ?>
                            <tr>
                                <th class="text-left">{{ $causelist->name }}</th>
                                <th class="text-left">{{ $causelist->name_en }}</th>
                                <th class="text-left">{{ $cname }}</th>
                                <td class="text-center">
                                    <a class="btn btn-primary btn-sm" href="{{ route('edit.causelist', ['id'=>$causelist->id]) }}">Edit</a>
                                    <a class="btn btn-danger btn-sm" href="{{ route('delete.causelist', ['id'=>$causelist->id]) }}" >Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 tab-pane fade" id="pills-addcauselist" role="tabpanel" aria-labelledby="pills-addcauselist-tab">
                    <form action="{{ route('add.causelist') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="home-page-label">Upload An PDF file For Your Announcement</label>
