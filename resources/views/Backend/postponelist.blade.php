        ...
        <div class="card website-settings-card shadow mb-5">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" >
                <li class="nav-item">
                    ...
                    id="pills-causelists-tab" data-toggle="pill" href="#pills-causelists" role="tab" aria-controls="pills-causelists"><i class="fa fa-pencil"></i> Edit Your Postpone Lists</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-addcauselist-tab" data-toggle="pill" href="#pills-addcauselist" role="tab" aria-controls="pills-addcauselist"><i class="fa fa-plus"></i> Add New Postpone List</a>
                </li>
            </ul>
            <!-- End Nav -->
            <!-- Start Body -->
            <div class="row tab-content mt-2" id="pills-tabContent">
                ...
                <div class="table-responsive col-lg-10 offset-1 col-md-12 col-sm-12 tab-pane fade show active"
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center">Postpone Lists</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-primary btn-sm" href="{{ route('edit.postponelist', ['id'=>$causelist->id]) }}">Edit</a>
                                    <a class="btn btn-danger btn-sm" href="{{ route('delete.postponelist', ['id'=>$causelist->id]) }}" >Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 tab-pane fade" id="pills-addcauselist" role="tabpanel" aria-labelledby="pills-addcauselist-tab">
                    <form action="{{ route('add.postponelist') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="home-page-label">Postpone List Name</label>
                            <input type="text" name="name" placeholder="Enter Your Cause List name.." class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="home-page-label">Postpone List Name (EN)</label>
                            <input type="text" name="name_en" placeholder="Enter Your Cause List name.." class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Postpone List Category</label>
