        ...
        <div class="card website-settings-card shadow mb-5">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" >
                <li class="nav-item">
                    ...
                    id="pills-articles-tab" data-toggle="pill" href="#pills-articles" role="tab" aria-controls="pills-articles"><i class="fa fa-pencil"></i> Edit Your Article</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-article-tab" data-toggle="pill" href="#pills-article" role="tab" aria-controls="pills-addarticle"><i class="fa fa-plus"></i> Add New Article</a>
                </li>
            </ul>
            <!-- End Nav -->
            <!-- Start Body -->
            <div class="row tab-content mt-2" id="pills-tabContent">
                ...
                <div class="table-responsive col-lg-10 offset-1 col-md-12 col-sm-12 tab-pane fade show active"
                    id="pills-articles" role="tabpanel" aria-labelledby="pills-articles-tab">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-primary btn-sm" href="{{ route('edit.article', ['id'=>$article->id]) }}">Edit Article</a>
                                    <a class="btn btn-danger btn-sm" href="{{ route('delete.article', ['id'=>$article->id]) }}" >Delete Article</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 tab-pane fade" id="pills-article" role="tabpanel" aria-labelledby="pills-addarticle-tab">
                    <form action="{{ route('add.article') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="home-page-label">Article Name</label>
                            <input type="text" name="name" placeholder="Enter Your Article name.." class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="home-page-label">Upload An Image file For Your Judge</label>
