...
<div class="row">
    <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12">
        <div class="card website-settings-card shadow mb-5">
            ...
            <div class="row tab-content mt-2" id="pills-tabContent">
                ...
                <div class="col-10 offset-1 tab-pane fade" id="pills-color" role="tabpanel" aria-labelledby="pills-color-tab">
                ...
                <!-- End Home Page Tab -->
                <!-- Start Meta Tags Tab -->
                <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 tab-pane fade  active show" id="pills-meta" role="tabpanel" aria-labelledby="pills-meta-tab">
                ...
                <div class="col-12 tab-pane fade" id="pills-password" role="tabpanel" aria-labelledby="pills-password-tab">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12  ml-4 mr-4">
                            <form method="POST" action="{{ route('add.admin') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="township" class="form-control" id="exampleFormControlSelect1">
                    ...
                    <hr>
                        ...
                        <tbody>
                            ...
                            <?php 
                        $results1 = DB::select('select * from districts where id = :id', ['id' => $user->district]);
                        
        foreach ($results1 as $district) {
            $distr = $district->name;
        }
                            
                        $results2 = DB::select('select * from townships where id = :id', ['id' => $user->tsp]);
                        
        foreach ($results2 as $township) {
            $townshipname = $township->name;
        }
                        $results3 = DB::select('select * from departments where id = :id', ['id' => $user->department]);
                        
        foreach ($results3 as $departments) {
            $department = $departments->name;
        }
                        $results4 = DB::select('select * from positions where id = :id', ['id' => $user->position]);
                        
        foreach ($results4 as $positions) {
    ...
    ?>
                            <tr>
                                ...
                                <th class="text-center">{{ $townshipname }}</th>
