...
Route::get('/announcements/{id}', 'FrontendController@SingelAnnouncementPage')->name('singleannouncement');
...
Route::get('/{id}/{title}', 'FrontendController@LocationsPage')->name('location');
